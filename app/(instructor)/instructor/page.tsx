      ...
      <aside className="w-64 bg-white dark:bg-[#111111] border-r border-slate-200 dark:border-slate-800 flex-col hidden lg:flex sticky top-0 h-screen shadow-sm">
        ...
        <nav className="flex-1 px-4 py-6 space-y-2">
           ...
           {[
             ...
             { id: 'courses', label: 'Kelola Kelas', icon: 'library_books' },
        ...
        <div className="p-6 border-t border-slate-200 dark:border-slate-800">
           <Link href="/my-class" className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold text-red-500 hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors">
                   ...
                   <form onSubmit={handleCreateCourse} className="space-y-5">
                      <div>
                        ...
                        <input 
                          ...
                          className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3.5 text-sm font-bold text-slate-900 dark:text-white focus:ring-2 focus:ring-[#00BCD4]/50 outline-none transition-all" 
                        />
                      </div>
